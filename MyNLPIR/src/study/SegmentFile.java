...
//			System.out.println("新词提取结果为：\n" + resultString);
			...
			Double d = instance.NLPIR_FileProcess("D:/NLPIR/sougou/big/bigfile.txt", "D:/NLPIR/segment/bigfileSegment.txt", 0);
...
//			System.out.println("从3.txt文件中提取关键词的结果为：\n" + resultString);
			...
			System.out.println("Time is :"+"一共花费："+((System.currentTimeMillis()-start))/1000+"s");
			instance.NLPIR_Exit();
			System.out.println("Time is :"+"一共花费："+((System.currentTimeMillis()-start))/1000+"s");
